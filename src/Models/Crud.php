...
class Crud extends Model
{
	...
	public static function generateBase($crud_name, $icon) {
		
		$names = CoreHelper::generateCrudNames($crud_name,$icon);
	...
	public static function generate($crud_name, $crud_name_db, $view_col, $faIcon = "fa-cube", $fields) {
		
		$names = CoreHelper::generateCrudNames($crud_name, $faIcon);
