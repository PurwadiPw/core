...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('core.adminRoute') . '/roles') }}" data-toggle="tooltip" data-placement="right" title="Back to Roles"><i class="fa fa-chevron-left"></i></a></li>
...
<link rel="stylesheet" type="text/css" href="{{ asset('core-assets/plugins/bootstrap-slider/slider.css') }}"/>
<style>
...
<script src="{{ asset('core-assets/plugins/bootstrap-slider/bootstrap-slider.js') }}"></script>
<script>
$(function () {
	@role(("SUPER_ADMIN"))
	/* ================== Access Control ================== */
