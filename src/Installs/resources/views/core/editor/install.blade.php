...
<div class="box">
	...
	<div class="box-body">
		<p>Core Code Editor does not comes inbuilt now. You can get it by following commands.</p>
		...
		<p>Now refresh this page or go to <a href="{{ url(config('core.adminRoute') . '/laeditor') }}">{{ url(config('core.adminRoute') . '/laeditor') }}</a>.</p>
	</div>
</div>
