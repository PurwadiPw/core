	...
	@endif
		...
		<div class="col-md-4">
			@if($module->view_col != "")
				...
				@else
					<div class="dats1 text-center"><a data-toggle="tooltip" data-placement="left" title="Generate Migration + CRUD + Crud" class="btn btn-sm btn-success" style="border-color:#FFF;" id="generate_migr_crud" href="#"><i class="fa fa-cube"></i> Generate Migration + CRUD</a></div>
...
<script src="{{ asset('core-assets/plugins/jQueryUI/jquery-ui.js') }}"></script>
