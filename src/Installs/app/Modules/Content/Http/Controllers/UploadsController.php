...
class UploadsController extends Controller
{
	...
	public function index()
	{
		...
		if(Crud::hasAccess($crud->id)) {
			return Theme::view('default::core.uploads.index', [
        ...
        if($upload->public || Entrust::hasRole('SUPER_ADMIN') || Auth::user()->id == $upload->user_id) {
            ...
            if(isset($size)) {
                ...
                if(File::exists($thumbpath)) {
                    ...
                    // Create Thumbnail
                    CoreHelper::createThumbnail($upload->path, $thumbpath, $size, $size, "transparent");
                    $path = $thumbpath;
                }
            }
    ...
    public function upload_files() {
		...
		if(Crud::hasAccess("Uploads", "create")) {
			$input = Input::all();
			...
			if(Input::hasFile('file')) {
				...
				*/
				...
				if( $upload_success ) {
					...
					// config("core.uploads.default_public")
    ...
    {
		if(Crud::hasAccess("Uploads", "view")) {
			$uploads = array();
    ...
    {
        if(Crud::hasAccess("Uploads", "edit")) {
    ...
    {
        if(Crud::hasAccess("Uploads", "delete")) {
			$file_id = Input::get('file_id');
