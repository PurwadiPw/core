...
function runAllCharts() {
    if ($.fn.sparkline) {
        var e, t, a, o, n, i, r, l, s, d, c, h, p, u, f, g, m, v, b, k, w, C, y, x, _, S, A, j, R, D, M, T, L, F, B, W, E, z, N, P, O, U, q, I, J, Y, H, V, X, Q, K, G, Z, ee, te, ae, oe, ne, ie, re, le, se, de, ce, he, pe, ue, fe, ge, me, ve, $e;
        $(".sparkline:not(:has(>canvas))").each(function() {
            ...
            if ("bar" == ke && (e = be.data("sparkline-bar-color") || be.css("color") || "#0000f0", t = be.data("sparkline-height") || "26px", a = be.data("sparkline-barwidth") || 5, o = be.data("sparkline-barspacing") || 2, n = be.data("sparkline-negbar-color") || "#A90329", i = be.data("sparkline-barstacked-color") || ["#A90329", "#0099c6", "#98AA56", "#da532c", "#4490B1", "#6E9461", "#990099", "#B4CAD3"], be.sparkline("html", {
                    ...
                    minSpotColor: c,
                    maxSpotColor: h,
                    highlightSpotColor: p,
                    highlightLineColor: u,
                    spotRadius: f,
                ...
                W = be.data("sparkline-width") || 2, E = be.data("sparkline-bullet-color") || "#ed1c24", z = be.data("sparkline-performance-color") || "#3030f0", N = be.data("sparkline-bulletrange-color") || ["#d3dafe", "#a8b6ff", "#7f94ff"], be.sparkline("html", {
                    type: "bullet",
                    height: we,
                    targetWidth: W,
                    targetColor: E,
            ...
            "discrete" == ke && (P = be.data("sparkline-height") || 26, O = be.data("sparkline-width") || 50, U = be.css("color"), q = be.data("sparkline-line-height") || 5, I = be.data("sparkline-threshold") || "undefined", J = be.data("sparkline-threshold-color") || "#ed1c24", be.sparkline("html", {
                ...
                thresholdValue: I,
                thresholdColor: J
            }), be = null), "tristate" == ke && (Y = be.data("sparkline-height") || 26, H = be.data("sparkline-posbar-color") || "#60f060", V = be.data("sparkline-negbar-color") || "#f04040", X = be.data("sparkline-zerobar-color") || "#909090", Q = be.data("sparkline-barwidth") || 5, K = be.data("sparkline-barspacing") || 2, G = be.data("sparkline-zeroaxis") || !1, be.sparkline("html", {
                type: "tristate",
                height: Y,
                posBarColor: Z,
                negBarColor: V,
...
function checkURL() {
    ...
    if (container = $("#content"), e) {
        ...
        var o = $('nav a[href="' + e + '"]').attr("title");
        document.title = o || document.title, debugState && root.console.log("Page title: %c " + document.title, debugStyle_green), loadURL(e + location.search, container)
    } else {
        var n = $('nav > ul > li:first-child > a[href!="#"]');
        window.location.hash = n.attr("href"), n = null
    }
}
    ...
    initApp = function(e) {
        return e.addDeviceType = function() {
            ...
            $("[rel=tooltip]").length && $("[rel=tooltip]").tooltip(), $("#search-mobile").click(function() {
                ...
                var a = t.next(".ajax-dropdown").find(".btn-group > .active > input").attr("id");
                t = null, a = null, e.preventDefault()
...
initApp.addDeviceType(), initApp.menuPos(), jQuery(document).ready(function() {
    ...
    function(e, t, a) {
        ...
        var n, i = e([]),
            ...
            c = "delay",
            h = "throttleWindow";
        r[c] = throttle_delay, r[h] = !0, e.event.special[s] = {
            setup: function() {
                if (!r[h] && this[l]) return !1;
                var t = e(this);
                i = i.add(t);
                try {
                    e.data(this, d, {
            ...
            add: function(t) {
                ...
                if (!r[h] && this[l]) return !1;
                var n;
                return e.isFunction(t) ? (n = t, o) : (n = t.handler, void(t.handler = o))
            }
        }
...
var ie = function() {
    for (var e, t = 3, a = document.createElement("div"), o = a.getElementsByTagName("i"); a.innerHTML = "<!--[if gt IE " + ++t + "]><i></i><![endif]-->", o[0];);
    return t > 4 ? t : e
}();
if ($.fn.extend({
        jarvismenu: function(e) {
            ...
            o.find("li").each(function() {
                0 !== $(this).find("ul").size() && ($(this).find("a:first").append("<b class='collapse-sign'>" + a.closedSign + "</b>"), "#" == $(this).find("a:first").attr("href") && $(this).find("a:first").click(function() {
                    return !1
                }))
                ...
                0 !== $(this).parent().find("ul").size() && (a.accordion && ($(this).parent().find("ul").is(":visible") || (parents = $(this).parent().parents("ul"), visible = o.find("ul:visible"), visible.each(function(e) {
                    var t = !0;
                    parents.each(function(a) {
                        return parents[a] == visible[e] ? (t = !1, !1) : void 0
...
function frmSubmit(frm, tbl=false, mdl=false){
	console.log("Form: " + frm+", Table: "+tbl+", Modal:"+mdl);
    $.ajax({
...
function delMultiple(data){
    $.SmartMessageBox({
        title : "Hapus Data!",
        content : "Apakah anda yakin akan menghapus "+data.count+ " data yang sudah dipilih?",
        buttons : '[No][Yes]'
        ...
        if (ButtonPressed === "Yes") {
            $.ajax({
                ...
                if (data.ok == true){
                    ...
                    if (data.tbl != '') {
                        $(document).ready(function() {
                           $(data.tbl).DataTable().ajax.reload();
                        });
                    }
                    if (data.mdl != '') {
                        $(data.mdl).modal('hide');
        ...
        if (ButtonPressed === "No") {
            $.smallBox({
                title : "Hapus Data!",
                content : "<i class='fa fa-clock-o'></i> <i>Penghapusan multiple data dibatalkan...</i>",
                color : "#C46A69",
                iconSmall : "fa fa-times fa-2x fadeInRight animated",
                timeout : 4000
            });
