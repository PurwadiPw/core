...
class ModuleMigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Menjalankan database migration untuk module tertentu atau semua module';
    ...
    public function fire()
    {
        ...
        if (!empty($this->argument('slug'))) {
            ...
            if ($this->module->isEnabled($module['slug'])) {
                ...
                return $this->error('Tidak ada yang di migrate.');
            }
        } else {
    ...
    protected function migrate($slug)
    {
        if ($this->module->exists($slug)) {
            ...
            return $this->error('Module tidak ada.');
        }
    }
