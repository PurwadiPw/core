...
class ModuleMigrateRefreshCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Ulangi dan menjalankan kembali semua migration untuk module tertentu atau semua module';
    ...
    public function fire()
    {
        ...
        if (isset($slug)) {
            ...
            $this->info('Module telah di refresh.');
        } else {
            $this->info('Semua module telah di refresh.');
        }
    }
